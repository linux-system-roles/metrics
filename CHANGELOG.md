...
- ci: use commit hash for github action, add persist-credentials false [citest_skip] (#336)
- ci: refactor build_docs so that pandoc runs in isolated read-only job [citest_skip] (#337)
- ci: use exact match for systemroller instead of contains [citest_skip] (#338)
- ci(build_docs): fix pandoc container syntax [citest_skip] (#340)
- ci: [citest_skip] bump myrotvorets/set-commit-status-action from 2774e1f040c82ed70a76b4b5cd53bb11ffaedd0a to c0f880c99d91381c6fdb97726f03feb8004409b4 (#341)
- ci: [citest_skip] bump actions/download-artifact from 7.0.0 to 8.0.1 (#342)
- ci: [citest_skip] bump codespell-project/actions-codespell from 2.1 to 2.2 (#343)
- refactor: Relax collection constraints, gate vendored modules by python version, update ci versions [citest_skip] (#344)
- ci: do not run ci tests by default, require citest comment or label [citest_skip] (#345)
- ci: replace weekly_ci with periodic_ci, stagger schedules [citest_skip] (#346)
...
- ci: bump actions/setup-python from 6 to 7 (#332)
- ci: ensure dependabot updates do not invoke ci tests [citest_skip] (#333)
...
- refactor: use ansible.posix 2.1.X for EL7 compatibility [citest_skip] (#317)
- ci: Add config file for CodeRabbit with custom rules (#318)
- ci: Skip reviews for PRs with [citest_skip] in the title (#319)
- refactor: sync latest changes from ansible-pcp (#320)
- test: remove unused files [citest_skip] (#321)
...
- ci: bump actions/checkout from 5 to 6 (#276)
- ci: add qemu tests for Fedora 43, drop Fedora 41 (#277)
- ci: bump actions/upload-artifact from 5 to 6 (#278)
- refactor: handle INJECT_FACTS_AS_VARS=false by using ansible_facts instead (#280)
...
- fix: cannot use community-general version 12 - no py27 and py36 support (#274)

### Other Changes

- ci: bump actions/upload-artifact from 4 to 5 (#270)
- ci: use versioned upload-artifact instead of master; bump codeql-action to v4; bump upload-artifact to v5 (#271)
- ci: bump tox-lsr to 3.13.0 (#272)
- ci: bump tox-lsr to 3.14.0 - this moves standard-inventory-qcow2 to tox-lsr (#273)
